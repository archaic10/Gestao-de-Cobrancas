...
//            List<Cliente> list = new ArrayList<Cliente>();            
            ...
            JOptionPane.showMessageDialog(null, sqle, "Erro", JOptionPane.ERROR_MESSAGE);
    ...
    public ArrayList<Cliente> obterDados(String dc) throws SQLException, Exception {
        String query = "SELECT * FROM cliente where documento ="+dc;
        System.out.println(query);
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
